...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cif_nif: Attribute.String;
    userType: Attribute.Enumeration<['user', 'professional']>;
    officeAddress: Attribute.Component<'chat.office-address'>;
    emailNotification: Attribute.Boolean;
    appNotification: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiChatChat extends Schema.CollectionType {
  ...
  attributes: {
    ...
    messages: Attribute.Relation<
      ...
      'api::message.message'
    >;
    professionalAssistance: Attribute.Enumeration<['Yes', 'No']>;
    expertiseArea: Attribute.String;
    isInformationSubmitted: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
